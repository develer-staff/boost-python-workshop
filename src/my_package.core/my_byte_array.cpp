...
struct my_byte_array_to_bytes
{
    ...
    {
        return PyBytes_FromStringAndSize(reinterpret_cast<const char*>(cpp_obj.data()),
                                         cpp_obj.size());
    }
};
...
struct my_byte_array_from_bytes
{
    ...
    {
        auto rvalue = reinterpret_cast<
                boost::python::converter::rvalue_from_python_storage<my_byte_array>*>(data);
